...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      else navigate('/church/dashboard')
    } catch (err) {
  ...
  return (
    <div className="min-h-screen flex" style={{ background: '#0F172A' }}>
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-14" style={{ background: 'linear-gradient(135deg, #0F172A 0%, #1E3A8A 50%, #1B4FD8 100%)' }}>
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: '#1B4FD8', border: '2px solid rgba(255,255,255,0.3)' }}>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div key={f.label} className="flex items-center gap-3 rounded-xl p-3" style={{ background: 'rgba(255,255,255,0.08)' }}>
      ...
      <div className="flex-1 flex items-center justify-center p-8" style={{ background: '#F8FAFF' }}>
        <div className="w-full max-w-md">
          <div className="text-center mb-10">
            <div className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-4" style={{ background: '#1B4FD8' }}>
          ...
          <div className="mt-8 p-4 rounded-xl border" style={{ background: '#EEF2FF', borderColor: '#C7D2FE' }}>
            ...
            <p className="text-xs text-gray-600">Super Admin: admin@churchesos.com / admin123</p>
